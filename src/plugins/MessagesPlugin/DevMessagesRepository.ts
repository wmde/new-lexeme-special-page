...
const messages: Record<MessageKeys, string> = {
	...
	'wikibaselexeme-newlexeme-error-no-language': 'No language selected, please select one.',
	'wikibaselexeme-newlexeme-error-no-lexical-category': 'No lexical category selected, please select one.',
	'wikibaselexeme-newlexeme-error-no-spelling-variant': 'No spelling variant selected, please select one.',
